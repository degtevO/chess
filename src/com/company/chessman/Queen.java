...
public class Queen extends AbstractChessman {
    ...
    protected boolean disableSquares(int x, int y, Board board) {
        ...
        // Мы дизаблим клеточки по 8-и направлениям.
        // Этот массив показывает, какие направления вышли за пределы доски
        boolean[] outs = {false, false, false, false, false, false, false, false};
        ...
        while(true) {
            ...
            delta++;
            // Если по всем 8 направлениям вышли за пределы доски, то заканчиваем цикл
